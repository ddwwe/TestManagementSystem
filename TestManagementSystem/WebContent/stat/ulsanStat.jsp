...
<%
	...
	List<String> ulsanList = (ArrayList<String>)session.getAttribute("ulsan");
	List<String> giSaList = (ArrayList<String>)session.getAttribute("giSaList");
	TableType giSaTableType = (TableType)session.getAttribute("ulsanGiSaTableType");
%>
				...
				<table border="1">
					<thead>
						<tr>
							...
							<th><%= ulsanList.get(i) %>&nbsp&nbsp</th>
							<%} %>
