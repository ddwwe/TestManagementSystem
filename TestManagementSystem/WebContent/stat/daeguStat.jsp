...
<%
	...
	List<String> daeguList = (ArrayList<String>)session.getAttribute("daegu");
	List<String> giSaList = (ArrayList<String>)session.getAttribute("giSaList");
	TableType giSaTableType = (TableType)session.getAttribute("daeguGiSaTableType");
%>
				...
				<table border="1">
					<thead>
						<tr>
							...
							<% for(int i=0; i < daeguList.size(); i++) { %>
							<th><%= daeguList.get(i) %>&nbsp&nbsp</th>
							<%} %>
