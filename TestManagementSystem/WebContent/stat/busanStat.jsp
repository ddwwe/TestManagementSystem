...
<%
	...
	List<String> busanList = (ArrayList<String>)session.getAttribute("busan");
	List<String> giSaList = (ArrayList<String>)session.getAttribute("giSaList");
	TableType giSaTableType = (TableType)session.getAttribute("busanGiSaTableType");
%>
				...
				<table border="1">
					<thead>
						<tr>
							...
							<th><%= busanList.get(i) %>&nbsp&nbsp</th>
							<%} %>
