...
<%
	...
	List<String> incheonList = (ArrayList<String>)session.getAttribute("incheon");
	List<String> giSaList = (ArrayList<String>)session.getAttribute("giSaList");
	TableType giSaTableType = (TableType)session.getAttribute("incheonGiSaTableType");
%>
				...
				<table border="1">
					<thead>
						<tr>
							...
							<th><%= incheonList.get(i) %>&nbsp&nbsp</th>
							<%} %>
