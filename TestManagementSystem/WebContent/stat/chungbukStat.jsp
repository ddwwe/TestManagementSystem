...
<%
	...
	List<String> chungbukList = (ArrayList<String>)session.getAttribute("chungbuk");
	List<String> giSaList = (ArrayList<String>)session.getAttribute("giSaList");
	TableType giSaTableType = (TableType)session.getAttribute("chungbukGiSaTableType");
%>
				...
				<table border="1">
					<thead>
						<tr>
							...
							<% for(int i=0; i < chungbukList.size(); i++) { %>
							<th><%= chungbukList.get(i) %>&nbsp&nbsp</th>
							<%} %>
