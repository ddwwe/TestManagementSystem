...
<%
	...
	List<String> chungnamList = (ArrayList<String>)session.getAttribute("chungnam");
	List<String> giSaList = (ArrayList<String>)session.getAttribute("giSaList");
	TableType giSaTableType = (TableType)session.getAttribute("chungnamGiSaTableType");
%>
				...
				<table border="1">
					<thead>
						<tr>
							...
							<% for(int i=0; i < chungnamList.size(); i++) { %>
							<th><%= chungnamList.get(i) %>&nbsp&nbsp</th>
							<%} %>
