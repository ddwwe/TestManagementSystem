...
<%
	...
	List<String> gyeonggiList = (ArrayList<String>)session.getAttribute("gyeonggi");
	List<String> giSaList = (ArrayList<String>)session.getAttribute("giSaList");
	TableType giSaTableType = (TableType)session.getAttribute("gyeonggiGiSaTableType");
%>
				...
				<table border="1">
					<thead>
						<tr>
							...
							<% for(int i=0; i < gyeonggiList.size(); i++) { %>
							<th><%= gyeonggiList.get(i) %>&nbsp&nbsp</th>
							<%} %>
