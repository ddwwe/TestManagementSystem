...
<%
	...
	List<String> gwangjuList = (ArrayList<String>)session.getAttribute("gwangju");
	List<String> giSaList = (ArrayList<String>)session.getAttribute("giSaList");
	TableType giSaTableType = (TableType)session.getAttribute("gwangjuGiSaTableType");
%>
				...
				<table border="1">
					<thead>
						<tr>
							...
							<% for(int i=0; i < gwangjuList.size(); i++) { %>
							<th><%= gwangjuList.get(i) %>&nbsp&nbsp</th>
							<%} %>
