...
<%
	...
	List<String> jejuList = (ArrayList<String>)session.getAttribute("jeju");
	List<String> giSaList = (ArrayList<String>)session.getAttribute("giSaList");
	TableType giSaTableType = (TableType)session.getAttribute("jejuGiSaTableType");
%>
				...
				<table border="1">
					<thead>
						<tr>
							...
							<th><%= jejuList.get(i) %>&nbsp&nbsp</th>
							<%} %>
